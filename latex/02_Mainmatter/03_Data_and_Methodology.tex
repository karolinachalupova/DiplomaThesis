	...
	\subsection{Predictor Descriptives}   	
		...
		\begin{center}
			\begin{sidewaysfigure}
				...
				\medskip
				\small
				The figure shows how the values of observations are distributed within each feature. The horizontal axis shows the values of the features (which range between $-1$ and $1$ due to normalization), and the vertical axis shows number of observations (or examples in ML terminology) within each bin, in millions.  
			\end{sidewaysfigure}
		\end{center} 
