...
\begin{document}
	...
	\input{01_Frontmatter/notation.tex}							%List of Acronyms
	\clearpage
	%-----<<< ---------------- >>>-----
	...
	\input{02_Mainmatter/01_Introduction.tex}              	%pdfa ok
	\input{02_Mainmatter/02_Literature.tex}					%pdfa ok
	\input{02_Mainmatter/03_Data_and_Methodology.tex}		% NOT OK
	\input{02_Mainmatter/04_Results.tex}					% NOT OK
	\input{02_Mainmatter/05_Conclusion.tex}					%pdfa ok
	\clearpage
	%-----<<< -------- >>>-----
	...
	\input{03_Backmatter/01_App.tex}           				% NOT OK 
	\input{03_Backmatter/02_App.tex}           				%numerical results, pdfa ok
	\input{03_Backmatter/03_App.tex}           			    %model reliance figure, pdfa ok
	\input{03_Backmatter/99_App.tex}           				%internet appendix, pdfa ok
	\clearpage
	%-----<<< --------- >>>-----
\end{document}
%-----<<<<<<<<< END OF DOCUMENT >>>>>>>>>-----
